...
Citizen.CreateThread(function()
    ...
    WarMenu.CreateMenu('PIS:main', 'PIS Menu (TCallouts)')
	WarMenu.SetTitleBackgroundColor('PIS:main', 110, 231, 35, 255)
	WarMenu.SetTitleColor('PIS:main', 255, 255, 255, 255)
	
	WarMenu.CreateSubMenu('PIS:wep', 'PIS:main', 'Weapons')
	WarMenu.SetTitleBackgroundColor('PIS:wep', 240, 0, 36, 255)
	WarMenu.SetTitleColor('PIS:wep', 255, 255, 255, 255)
	
	WarMenu.CreateSubMenu('PIS:arr', 'PIS:main', 'Arrests (WIP)')
	WarMenu.SetTitleBackgroundColor('PIS:arr', 240, 68, 0, 255)
	WarMenu.SetTitleColor('PIS:arr', 255, 255, 255, 255)
	
	WarMenu.CreateSubMenu('PIS:int', 'PIS:main', 'Interactions')
	WarMenu.SetTitleBackgroundColor('PIS:int', 0, 200, 240, 255)
	WarMenu.SetTitleColor('PIS:int', 255, 255, 255, 255)
	
	WarMenu.CreateSubMenu('PIS:rdo', 'PIS:main', 'Interactions')
	WarMenu.SetTitleBackgroundColor('PIS:rdo', 0, 200, 240, 255)
	WarMenu.SetTitleColor('PIS:rdo', 255, 255, 255, 255)
	
	WarMenu.CreateSubMenu('PIS:misc', 'PIS:main', 'Other')
	WarMenu.SetTitleBackgroundColor('PIS:misc', 216, 0, 240, 255)
	WarMenu.SetTitleColor('PIS:misc', 255, 255, 255, 255)
	
	WarMenu.CreateSubMenu('PIS:credits', 'PIS:credits', 'Credits')
	WarMenu.SetTitleBackgroundColor('PIS:credits', 216, 0, 240, 255)
	WarMenu.SetTitleColor('PIS:credits', 255, 255, 255, 255)
    ...
    while true do
        if WarMenu.IsMenuOpened('PIS:main') then
			...
			elseif WarMenu.MenuButton('Credits', 'PIS:credits') then
        ...
        elseif WarMenu.IsMenuOpened('PIS:int') then
			...
			elseif WarMenu.Button('Ask ID') then
				TriggerEvent("pis:askidped")
            end
        ...
        elseif WarMenu.IsMenuOpened('PIS:misc') then
			...
			elseif WarMenu.Button('TCallouts Credits') then
				TriggerEvent("pis:tcallouts")
            end
...
Citizen.CreateThread(function()
	...
	WarMenu.SetTitleBackgroundColor('PIS:call:mnu', 255, 117, 199, 255)
    ...
    while true do
        if WarMenu.IsMenuOpened('PIS:call:mnu') then
			...
			elseif WarMenu.Button('Shots Fired') then
				...
				TriggerEvent('pis:notification', -1)
				elseif WarMenu.Button('Shots Fired City [TCallouts]') then
				TriggerEvent('pis:shotscity:spawn', s)
					Wait(2000)
				TriggerEvent('pis:shotscity', -1)
				TriggerEvent('pis:notification', -1)
				elseif WarMenu.Button('Possible Armed Robbery [TCallouts]') then
				TriggerEvent('pis:robbery:spawn', s)
					Wait(2000)
				TriggerEvent('pis:robbery', -1)
				TriggerEvent('pis:notification', -1)
				elseif WarMenu.Button('Bank Robbery [TCallouts]') then
				TriggerEvent('pis:bank:spawn', s)
					Wait(2000)
				TriggerEvent('pis:bank', -1)
				TriggerEvent('pis:notification', -1)
				elseif WarMenu.Button('Bank Robbery v2 [TCallouts]') then
				TriggerEvent('pis:bank2:spawn', s)
					Wait(2000)
				TriggerEvent('pis:bank2', -1)
				TriggerEvent('pis:notification', -1)
...
Citizen.CreateThread(function()
	...
	WarMenu.SetTitleBackgroundColor('PIS:call', 240, 0, 0, 255)
	WarMenu.SetTitleColor('PIS:call', 255, 255, 255, 255)
	
	WarMenu.CreateSubMenu('call:cd4', 'PIS:call' ,'Are you sure?')
	WarMenu.SetTitleBackgroundColor('call:cd4', 240, 0, 0, 255)
