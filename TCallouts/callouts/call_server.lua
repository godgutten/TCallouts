AddEventHandler('chatMessage', function(s, n, m)
	...
	elseif message == "/callout crazy" then
		...
		TriggerClientEvent('pis:notification', -1)
	elseif message == "/callout bank" then
		CancelEvent()
		--------------
		TriggerClientEvent('pis:bank:spawn', s)
		Wait(2000)
		TriggerClientEvent('pis:bank', -1)
		TriggerClientEvent('pis:notification', -1)
	elseif message == "/callout arobbery" then
		CancelEvent()
		--------------
		TriggerClientEvent('pis:robbery:spawn', s)
		Wait(2000)
		TriggerClientEvent('pis:robbery', -1)
		TriggerClientEvent('pis:notification', -1)
	end
end)